...
public interface FinalizeTranscoderArgsListener extends PluginBase {
	/**
	 * Called before the transcoding of a resource starts to determine the list of commands to be used
	 * 
	 * @param player the player being used
	 * @param filename the name of the file being transcoded
	 * @param dlna the DLNAResource being transcoded
	 * @param media the DLNAMediaInfo for the file being transcoded
	 * @param params the used OutputParams
	 * @param cmdList the list of commands
	 * @return the exhaustive list of all commands. It will replace the ones received as cmdList
	 */
