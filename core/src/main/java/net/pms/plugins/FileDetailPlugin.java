...
public interface FileDetailPlugin extends PluginBase {
	 ...
	 * If null is being returned the menu item to configure the plugin will be disabled.
	 * 
	 ...
	 * This method will be called right before calling getResource
	 * 
	 * @param videoFileInfo object containing all information about the video being browsed
	 */
	 ...
	 * E.g. the tmdb rating plugin will return false if no credentials have been set
	 * 
