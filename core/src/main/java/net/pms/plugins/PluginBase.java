...
public interface PluginBase {
	...
	/**
	 * Gets the icon that will be shown in the plugins tab. It should have a size of 32x32
	 * 
	 * @return the icon
	 */
	...
	/**
	 * Gets the short description of the plugin that will be shown in the pms plugin panel<br>
	...
	/**
	 * Gets the long description of the plugin that will be shown in the pms plugin dialog<br>
	 * It should be localized.
	 * 
	...
	/**
	 * Gets the url of the file containing information about the current plugin version<br>
	 ...
	 * This link can e.g. be a link to a forum post, a web site or null if no web site exists
	 * 
