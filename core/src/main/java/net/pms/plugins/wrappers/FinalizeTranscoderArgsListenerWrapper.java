...
/**
 * Wraps the old style plugin {@link net.pms.external.FinalizeTranscoderArgsListener} to be used by the new plugin
 * system
 */
...
public class FinalizeTranscoderArgsListenerWrapper extends BaseWrapper implements FinalizeTranscoderArgsListener {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.pms.plugins.FinalizeTranscoderArgsListener#finalizeTranscoderArgs(net.pms.encoders.Player,
	 * java.lang.String, net.pms.dlna.DLNAResource, net.pms.dlna.DLNAMediaInfo, net.pms.io.OutputParams, java.util.List)
	 */
	@Override
