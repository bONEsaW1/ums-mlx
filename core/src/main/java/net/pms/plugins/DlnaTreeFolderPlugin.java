...
public interface DlnaTreeFolderPlugin extends PluginBase {
	...
	/***
	 * Gets the configuration component that will be shown to the user for editing in the pms client.<br>
	 * If null is being returned, the edit option won't be enabled in the context menu of the pms client tree
	 * 
	 * @return the panel to configure the plugin or null if no configuration is required
	 */
	 ...
	 * 
	 * @return the dlna resource that will be displayed when browsing the renderer
	 */
	 ...
	 * @param saveFilePath The path to which the configuration has to be saved to
	 */
	 ...
	 * @exception IOException can be thrown when the file couldn't be loaded
	 */
