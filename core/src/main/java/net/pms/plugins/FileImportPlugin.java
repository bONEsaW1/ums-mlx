...
public interface FileImportPlugin extends PluginBase {
	...
	/**
	 * Tells if the methods searchForFile and importFileBySearchObject can be called
	 * 
	 * @return true if searchForFile and importFileBySearchObject can be called, false otherwise
	...
	/**
	 * Import file properties based on the search object (having been previously returned by searchForFile)
	 * 
	 * @param searchObject the object containing the required information to collect the import data
	 * @see #searchForFile(String name)
	 */
	public void importFileBySearchObject(Object searchObject);

	/**
	 * Returns a list containing all file properties for which it is possible to call getFileProperty()
	 * 
	 ...
	 * 
	 * @param property The file property for which to get the value
