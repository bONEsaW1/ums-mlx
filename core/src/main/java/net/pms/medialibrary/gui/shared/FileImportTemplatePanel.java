...
public class FileImportTemplatePanel extends JPanel {
	...
	private JTabbedPane buildTabbedPane() {
		...
		// ImageIcon(getClass().getResource("/resources/images/audiofolder-16.png")), fippsAudio);
		// tp.addTab(Messages.getString("ML.FileType.PICTURES"), new
		// ImageIcon(getClass().getResource("/resources/images/picturesfolder-16.png")), fippsPictures);
