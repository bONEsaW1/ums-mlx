...
public class DOFileImportTemplate {
	...
	public void addEngineConfiguration(DOFileScannerEngineConfiguration engineConfiguration) {
		...
		if (engineConfigurations == null)
			engineConfigurations = new ArrayList<DOFileScannerEngineConfiguration>();
	...
	public Map<FileType, List<String>> getEnabledEngines() {
		if (enabledEnginesForFileType == null)
			enabledEnginesForFileType = new HashMap<FileType, List<String>>();
		if (!enabledEnginesForFileType.containsKey(FileType.VIDEO))
			enabledEnginesForFileType.put(FileType.VIDEO, new ArrayList<String>());
		if (!enabledEnginesForFileType.containsKey(FileType.AUDIO))
			enabledEnginesForFileType.put(FileType.AUDIO, new ArrayList<String>());
		if (!enabledEnginesForFileType.containsKey(FileType.PICTURES))
			enabledEnginesForFileType.put(FileType.PICTURES, new ArrayList<String>());
		if (!enabledEnginesForFileType.containsKey(FileType.FILE))
			enabledEnginesForFileType.put(FileType.FILE, new ArrayList<String>());
	...
	public Map<FileType, Map<String, List<String>>> getEnabledTags() {
		if (enabledTags == null)
			enabledTags = new HashMap<FileType, Map<String, List<String>>>();
		if (!enabledTags.containsKey(FileType.VIDEO))
			enabledTags.put(FileType.VIDEO, new HashMap<String, List<String>>());
		if (!enabledTags.containsKey(FileType.AUDIO))
			enabledTags.put(FileType.AUDIO, new HashMap<String, List<String>>());
		if (!enabledTags.containsKey(FileType.PICTURES))
			enabledTags.put(FileType.PICTURES, new HashMap<String, List<String>>());
		if (!enabledTags.containsKey(FileType.FILE))
			enabledTags.put(FileType.FILE, new HashMap<String, List<String>>());
