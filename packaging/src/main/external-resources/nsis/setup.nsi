...
Section "Program Files"
  ...
  File /r /x "*.conf" /x "*.zip" /x "*.dll" /x "third-party" /x "transcode-tools" "${PROJECT_CORE_BASEDIR}\src\main\external-resources\plugins"
  File /r "${PROJECT_BASEDIR}\src\main\resources" ;Contains images used by the media library
  ...
  File "${PROJECT_CORE_BASEDIR}\src\main\external-resources\DummyInput.ass"

  ; The user may have set the installation dir as the profile dir, so we can't clobber this
  SetOverwrite off
  File "${PROJECT_CORE_BASEDIR}\src\main\external-resources\UMS.conf"
  File "${PROJECT_CORE_BASEDIR}\src\main\external-resources\WEB.conf"
  File "${PROJECT_CORE_BASEDIR}\src\main\external-resources\ffmpeg.webfilters"
