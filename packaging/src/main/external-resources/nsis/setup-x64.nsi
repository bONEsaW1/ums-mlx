...
!macro checkSystemOS
  ${IfNot} ${RunningX64}
    MessageBox MB_ICONSTOP "Can't install on non 64-bit OS. Please download and install UMS-setup-full.exe."
    Abort
  ${EndIf}
!macroend
...
!macro installPrivateJRE
  ...
  File "${PROJECT_BASEDIR}\src\main\external-resources\UMS-x64.bat"
...
!macro uninstallPrivateJRE
  ...
  Delete /REBOOTOK "$INSTDIR\UMS-x64.bat"
!macroend
