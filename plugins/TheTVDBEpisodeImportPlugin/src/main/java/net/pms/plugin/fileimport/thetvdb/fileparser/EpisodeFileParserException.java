...
public class EpisodeFileParserException extends Exception {
	...
	/**
	 * Creates a new instance of <code>EpisodeFileParserException</code> without detail message.
	 */
	public EpisodeFileParserException() {
	}

	/**
	 * Constructs an instance of <code>EpisodeFileParserException</code> with the specified detail message.
	 *
